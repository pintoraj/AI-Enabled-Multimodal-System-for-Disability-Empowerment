...
import wikipedia
import openai
from Features import Automations
import pickle
import cv2
...
def TaskExe():
    ...
    if choice == '1':
        while True:
            ...
            labels_dict = {
                0: 'Hey', 1: '', 2: 'Blind Stick Off', 3: 'Light ON', 4: 'Light OFF',
                5: 'Whatsapp message',
                6: 'My Location', 7: 'Let me ask you a question', 8: 'Where is ', 9: 'write a note',
                10: 'call', 11: 'play some song', 12: 'who is ', 13: 'Google search', 14: 'Bye', 15: 'Activate the Bulb',
            ...
            while True:
                ...
                if cv2.waitKey(1) & 0xFF == ord('q'):
                    ...
                    if 'google search' in query:
                        ...
                        query = input(" ")
                        from Features.Features import YouTubeSearch
                        YouTubeSearch(query)
                        ...
                        from Features.Features import DownloadYouTube
                        DownloadYouTube()
                        ...
                        MSG = input(" ")
                        from Features.Automations import WhatsappMsg
                        WhatsappMsg(Name, MSG)


                    elif 'call' in query:
                        from Features.Automations import WhatsappCall
                        ...
                        Speak("With Whom ?")
                        name = input(" ")
                        from Features.Automations import WhatsappChat
                        WhatsappChat(name)
                        ...
                        from Features.Features import My_Location
                        My_Location()

                    elif 'where is' in query:

                        from Features.Automations import GoogleMaps
                        ...
                        from Features.Automations import CloseNotepad
                        ...
                        from Features.Features import CoronaVirus
        ...
        while True:
            ...
            if 'google search' in query:
                ...
                from Features.Automations import Notepad
                Notepad()
